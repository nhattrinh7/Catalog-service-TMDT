...
export class GetProductReviewsPaginatedQueryDto extends createZodDto(
  GetProductReviewsPaginatedQuerySchema,
) {}
...
export class GetShopReviewsPaginatedQueryDto extends createZodDto(
  GetShopReviewsPaginatedQuerySchema,
) {}
...
export class GetReportedReviewsPaginatedQueryDto extends createZodDto(
  GetReportedReviewsPaginatedQuerySchema,
) {}
