...
import {
  ...
  type ProductWithLevel1Category,
} from '~/domain/repositories/product.repository.interface'

@QueryHandler(GetProductsWithLevel1CategoriesQuery)
export class GetProductsWithLevel1CategoriesHandler
  implements IQueryHandler<GetProductsWithLevel1CategoriesQuery, ProductWithLevel1Category[]>
{
  constructor(
